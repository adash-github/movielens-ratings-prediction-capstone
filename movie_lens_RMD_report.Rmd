...
Let us first take a look at the user breakdown. What you will notice is that some users are a lot more active than others. But from a general stand point we see most users fall between reviewing/rating 10 to 100 movies. 
...
This graph shows the frequency of the number of reviews. For example we can see the frequency of 100 reviews, or 500, etc. This just tells us that some peope review a lot of movies, and some only review a few movies. Now we can look at a plot of the user bias. We can do that by creating another histogram.
...
The following graph shows how different genres have different average ratings. This is important as we want to utilize genres as an effect in our model.
